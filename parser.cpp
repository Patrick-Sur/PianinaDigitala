...
{
       0,   120,   120,   121,   125,   129,   147,   148,   149,   153,
     154,   155,   159,   160,   161,   162,   163
};
#endif
...
#line 159 "proiect.y"
                                  { (yyval.real_val) = (double)(yyvsp[0].duration_val); }
#line 1229 "parser.cpp"
    break;

  case 13: /* modificare_durata: SLASH DURATION  */
#line 160 "proiect.y"
                                  { (yyval.real_val) = 1.0 / (double)(yyvsp[0].duration_val); }
#line 1235 "parser.cpp"
    break;

  case 14: /* modificare_durata: DURATION SLASH DURATION  */
#line 161 "proiect.y"
                                  { (yyval.real_val) = (double)(yyvsp[-2].duration_val) / (double)(yyvsp[0].duration_val); }
